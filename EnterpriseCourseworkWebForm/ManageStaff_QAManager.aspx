<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageStaff_QAManager.aspx.cs" Inherits="EnterpriseCourseworkWebForm.ManageStaff_Admin" %>
           ...
           <div class="div2">
                    ...
                    <asp:GridView ID="grdPivot" runat="server" class="datagridview" DataSourceID="DataSource" RowHeaderColumn="Change status" OnRowCommand="grdPivot_RowCommand"  OnSelectedIndexChanged="grdPivot_SelectedIndexChanged" AutoGenerateColumns="False" DataKeyNames="RegisteredStaffID" >
                        <Columns>
                         ...
                         <asp:LinqDataSource   ID="DataSource" runat="server" ContextTypeName="EnterpriseCourseworkWebForm.DataClassesUniversityDataContext" TableName="RegisteredStaffs" EntityTypeName=""></asp:LinqDataSource>
                        </asp:Panel>
               </div>
